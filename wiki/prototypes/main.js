...
window.onload = function() {
	...
	for(var index = 0, size = lists.length; index < size; index++) {
		...
		if(element.tagName == "UL" || element.tagName == "DIV") {
			...
			child.src = rootUrl + "img/arrow-gray-right.gif";
...
function dropList(e) {
	...
	if(element.style.display === "none") {
		...
		parent.getElementsByTagName("img")[0].src = rootUrl + "img/arrow-gray-bottom.gif";
	} else {
		element.style.display = "none";
		parent.getElementsByTagName("img")[0].src = rootUrl + "img/arrow-gray-right.gif";
	}
}
