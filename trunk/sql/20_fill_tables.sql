...
INSERT INTO `user`
(`id`,  `name`,         `password`,                  `first_name`, `middle_name`,  `last_name`, `is_admin`, `group_id`) VALUES
...
(`id`,  `name`, `regexp`) VALUES
(20001, 'kont', '.*');

INSERT INTO `contact`
(`id`,  `name`,           `user_id`, `type_id`) VALUES
...
(`id`,  `name`,           `parent_id`) VALUES
(20001, 'usual_project',  NULL),
(20002, 'simple_project', 20001);

INSERT INTO `project`
(`id`,  `name`,   `description`,          `category_id`, `manager_id`) VALUES
...
INSERT INTO `team`
(`id`,  `project_id`, `leader_id`) VALUES
(20001, 20001,        20001),
(20002, 20002,        20002),
(20003, 20003,        20003),
(20004, 20004,        20003),
...
(`id`,  `user_id`, `team_id`, `role`) VALUES
(20001, 20001,     20001,     0),
(20002, 20004,     20001,     1),
(20003, 20002,     20002,     1),
(20004, 20003,     20003,     0),
...
INSERT INTO `module`
(`id`,  `name`,       `parent_id`, `project_id`) VALUES
(20001, 'Left',       NULL,        20001),
(20002, 'Right',      NULL,        20001),
(20003, 'Left_Up',    20001,       20001),
(20004, 'Right_Up',   20002,       20001),
(20005, 'Left_Down',  20001,       20001),
(20006, 'Right_Down', 20002,       20001);

INSERT INTO `use_case`
(`id`,  `name`,         `module_id`) VALUES
...
(`id`,  `source_id`, `destination_id`, `type`) VALUES
(20001, 20002,       20005,            2),
(20002, 20004,       20006,            2);

INSERT INTO `actor_use_case_relation`
(`id`,  `actor_id`, `use_case_id`) VALUES
(20001, 20001,      20001),
(20002, 20001,      20003),
(20003, 20003,      20002),
(20004, 20003,      20004),
...
(`id`,  `name`,      `description`, `importance`, `change_probability`, `use_case_id`, `module_id`) VALUES
(20001, 'Simmetric', 'Left~Right',  1,            1,                    20001,         NULL);
...
INSERT INTO `task`
(`id`,  `name`,    `description`,        `plan_time`, `difficulty`, `open_date`, `module_id`, `status`) VALUES
(20001, 'Start',   'Start developing',   2,           0.9,          "2015-01-01", 20001,      0),
(20002, 'Start 2', 'Start developing 2', 2,           0.8,          "2015-01-01", 20002,      0);

INSERT INTO `tasks_dependency`
(`id`,  `task_id`, `dependent_task_id`) VALUES
(20001, 20001,     20002);