...
public class TeamDaoTest {
	public static void main(String[] args) throws PersistentException, SQLException {
		...
		assert create_team.getLeader().getId() == read_team.getLeader().getId() && create_team.getProject().getId() == read_team.getProject().getId() : "Failed on read";
		...
		assert update_team.getLeader().getId() == read_team.getLeader().getId() && update_team.getProject().getId() == read_team.getProject().getId() : "Failed on update";
