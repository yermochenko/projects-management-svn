...
public class ContactsTypeEditServlet extends HttpServlet {
	...
	private static Logger logger = Logger.getLogger(ContactsTypeEditServlet.class);
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			ContactsType contactsType = contactsTypeService.findById(identity);
			request.setAttribute("type", contactsType);
		...
		String jspPage = "/WEB-INF/jsp/admin/contacts-type/edit.jsp";
