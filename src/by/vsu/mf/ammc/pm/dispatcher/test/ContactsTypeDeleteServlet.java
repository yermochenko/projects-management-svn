...
public class ContactsTypeDeleteServlet extends HttpServlet {
	...
	private static Logger logger = Logger.getLogger(ContactsTypeDeleteServlet.class);
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			logger.debug(String.format("Identity value: " + identity));
			...
			if(identity != null) {
				contactsTypeService.delete(identity);
			}
			String contextPath = request.getContextPath();
			logger.debug(String.format(contextPath));
